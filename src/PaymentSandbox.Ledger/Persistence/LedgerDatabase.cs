...
/// <summary>Opens ledger SQLite connections and applies its owned migrations.</summary>
public sealed class LedgerDatabase
{
    ...
    public LedgerDatabase(LedgerDatabaseOptions options, TimeProvider timeProvider)
    {
    ...
    public async Task InitializeAsync(CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new InvalidOperationException("The ledger database path has no parent directory.");
        }
        ...
        Dictionary<long, string> applied = await ReadAppliedMigrationsAsync(
            ...
            transaction,
            cancellationToken);
        long latestKnownVersion = LedgerDatabaseMigrations.All[^1].Version;
        ...
        foreach (LedgerDatabaseMigration expected in LedgerDatabaseMigrations.All)
        {
        ...
        foreach (LedgerDatabaseMigration migration in LedgerDatabaseMigrations.All)
        {
